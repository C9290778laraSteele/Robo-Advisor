...
export function ApiKeysModal({ 
  ...
  const [openAIKey, setOpenAIKey] = useState(getOpenAIApiKey() || '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');
  const [financialKey, setFinancialKey] = useState(getFinancialDatasetsApiKey() || 'e9b8cd42-d1d6-4f20-ac99-c1699fbfeb39');
